...
The HealthChainAPI coordinates events across all registered components. This is useful for auditing, workflow automation, and other use cases. For more information, see the **[Events](https://healthchainai.github.io/HealthChain/reference/gateway/events/index.md)** page.
...
- **[FHIR Gateway](https://healthchainai.github.io/HealthChain/reference/gateway/fhir_gateway/index.md)**: Complete FHIR operations reference
- **[CDS Hooks Service](https://healthchainai.github.io/HealthChain/reference/gateway/cdshooks/index.md)**: Complete CDS Hooks service reference
- **[NoteReader Service](https://healthchainai.github.io/HealthChain/reference/gateway/soap_cda/index.md)**: Complete NoteReader service reference
