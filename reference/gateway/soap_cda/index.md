...
You can use the [CdaAdapter](https://healthchainai.github.io/HealthChain/reference/io/adapters/cdaadapter/index.md) to handle conversion between CDA documents and HealthChain pipeline data containers.
