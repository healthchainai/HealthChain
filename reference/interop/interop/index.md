...
| --------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| [**InteropEngine**](https://healthchainai.github.io/HealthChain/reference/interop/engine/index.md)        | Core engine that manages the conversion process                              |
| [**Templates**](https://healthchainai.github.io/HealthChain/reference/interop/templates/index.md)         | Liquid-based template system for customizing output syntactic generation     |
| [**Mappings**](https://healthchainai.github.io/HealthChain/reference/interop/mappings/index.md)           | Mappings between different terminology systems                               |
| [**Configuration**](https://healthchainai.github.io/HealthChain/reference/interop/configuration/index.md) | Configuration system for controlling engine behavior and template variations |
| [**Parsers**](https://healthchainai.github.io/HealthChain/reference/interop/parsers/index.md)             | Components for parsing different healthcare formats                          |
| [**Generators**](https://healthchainai.github.io/HealthChain/reference/interop/generators/index.md)       | Components for generating output in different formats                        |
...
For detailed implementation examples, see [Creating a Custom Parser](https://healthchainai.github.io/HealthChain/reference/interop/parsers/#creating-a-custom-parser).
...
For detailed implementation examples, see [Creating a Custom Generator](https://healthchainai.github.io/HealthChain/reference/interop/generators/#creating-a-custom-generator).
...
1. Add new templates for custom formats or content types
1. Extend the template system with custom logic via filters

For more details on extending the system, check out the [Templates](https://healthchainai.github.io/HealthChain/reference/interop/templates/index.md) and [Configuration](https://healthchainai.github.io/HealthChain/reference/interop/configuration/index.md) pages.
