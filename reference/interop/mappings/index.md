...
| ------------ | -------------------------------------- | ----------------------------- |
| `map_system` | Maps between CDA and FHIR code systems | \`{{ "http://snomed.info/sct" |
| `map_status` | Maps between CDA and FHIR status codes | \`{{ "active"                 |
...
1. Follow the structure of existing mapping files
1. The changes will be automatically loaded the next time the `InteropEngine` is initialized
...
- [Configuration Management](https://healthchainai.github.io/HealthChain/reference/interop/configuration/index.md)
- [Templates](https://healthchainai.github.io/HealthChain/reference/interop/templates/index.md)
- [Custom Filters](https://healthchainai.github.io/HealthChain/reference/interop/templates/#custom-template-filters)
