...
[(Full Documentation on Clinical Documentation)](https://healthchainai.github.io/HealthChain/reference/gateway/soap_cda/index.md)

## Input and Output

| Input                                                                                                                        | Output                                                                                                                           | Document Access                                                                |
| ---------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| [**CdaRequest**](https://healthchainai.github.io/HealthChain/api/sandbox/#healthchain.models.requests.cdarequest.CdaRequest) | [**CdaResponse**](https://healthchainai.github.io/HealthChain/api/sandbox/#healthchain.models.responses.cdaresponse.CdaResponse) | `Document.fhir.problem_list`, `Document.fhir.medication_list`, `Document.text` |
