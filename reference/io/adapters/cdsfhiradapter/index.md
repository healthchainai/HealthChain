...
[(Full Documentation on Clinical Decision Support)](https://healthchainai.github.io/HealthChain/reference/gateway/cdshooks/index.md)

## Input and Output

| Input                                                                                                                        | Output                                                                                                                           | Document Access                                                |
| ---------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| [**CDSRequest**](https://healthchainai.github.io/HealthChain/api/sandbox/#healthchain.models.requests.cdsrequest.CDSRequest) | [**CDSResponse**](https://healthchainai.github.io/HealthChain/api/sandbox/#healthchain.models.responses.cdsresponse.CDSResponse) | `Document.fhir.get_prefetch_resources()`, `Document.cds.cards` |
