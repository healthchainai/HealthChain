...
See [Data Generator](https://healthchainai.github.io/HealthChain/reference/utilities/data_generator/index.md) for more details on `.load_free_text()` `generate_synthetic` field.
